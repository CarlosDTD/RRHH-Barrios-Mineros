...
const PersonalForm = ({ personal, catalogos, onClose, onSave }) => {
  ...
  const selectClass = `w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl outline-none text-sm font-bold text-slate-700 shadow-sm cursor-pointer`;
  const selectClassEmerald = `w-full px-4 py-2.5 bg-white border border-emerald-100 rounded-xl outline-none text-sm font-bold text-slate-700 shadow-sm cursor-pointer`;
